...
(function ($) {
    class $hyoo_play extends $mol_drop {
        ...
        File(index) {
            const obj = new this.$.$mol_view();
            obj.sub = () => [
                this.File_play(index),
                this.File_drop(index)
            ];
            return obj;
        }
        Sources() {
        ...
        File_play(index) {
            ...
            obj.title = () => this.file_title(index);
            obj.enabled = () => this.file_enabled(index);
            obj.click = (event) => this.file_play(index, event);
            return obj;
        }
        file_drop(index, event) {
            if (event !== undefined)
                return event;
            return null;
        }
        File_drop_icon(index) {
            const obj = new this.$.$mol_icon_cross();
            return obj;
        }
        File_drop(index) {
            const obj = new this.$.$mol_button_minor();
            obj.click = (event) => this.file_drop(index, event);
            obj.sub = () => [
                this.File_drop_icon(index)
            ];
            return obj;
        }
    }
